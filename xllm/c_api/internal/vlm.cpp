...
XLLM_CAPI_EXPORT XLLM_VLM_Handler* xllm_vlm_create(void) {
  XLLM_VLM_Handler* handler = new XLLM_VLM_Handler();
...
XLLM_CAPI_EXPORT void xllm_vlm_init_options_default(
  ...
  *init_options = XLLM_INIT_VLM_OPTIONS_DEFAULT;
}

XLLM_CAPI_EXPORT bool xllm_vlm_initialize(
  ...
  try {
    ...
    xllm::helper::set_init_options(
        xllm::helper::BackendType::VLM, init_options, &xllm_init_options);
...
XLLM_CAPI_EXPORT void xllm_vlm_request_params_default(
  ...
  *request_params = XLLM_VLM_REQUEST_PARAMS_DEFAULT;
}
...
XLLM_CAPI_EXPORT XLLM_Response* xllm_vlm_chat_completions(
  ...
  return xllm::helper::handle_inference_request(
      handler,
      xllm::helper::InferenceType::VLM_CHAT_COMPLETIONS,
      model_id,
      xllm_messages,
      timeout_ms,
      request_params);
